...
export default function AdminPaymentSettingsPage() {
  ...
  const [settings, setSettings] = useState({
    ...
    // Pro Bids & Membership (Bids & Membership page)
    freeBidsPerMonth: 3,
    pricePerBid: 2.5,
    basicPlanPrice: 5,
    basicPlanBids: 2,
          ...
          <TabsContent value="other" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription className="font-['Poppins',sans-serif]">
                  These values drive the Bids & Membership page for professionals: free bids per month, price per bid (for custom quantity), and the Basic, Standard, and Premium plan prices and bid counts.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => updateField("freeBidsPerMonth", parseNumberInput(e.target.value, "int") || 0)}
                      className="mt-2 font-['Poppins',sans-serif] no-spinner"
                      min="0"
                    />
                    <p className="font-['Poppins',sans-serif] text-[11px] text-[#6b6b6b] mt-1">
                      Number of free bids each professional gets every month.
                    </p>
                  </div>
                  <div>
                    ...
                    <div className="relative mt-2">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 font-['Poppins',sans-serif]">£</span>
                      <Input
                        id="pricePerBid"
                        type="number"
                        value={settings.pricePerBid === "" ? "" : settings.pricePerBid ?? 2.5}
                        onChange={(e) => updateField("pricePerBid", parseNumberInput(e.target.value, "float") || 0)}
                        className="pl-8 font-['Poppins',sans-serif] no-spinner"
                        min="0"
                        step="0.01"
                      />
                    ...
                    <p className="font-['Poppins',sans-serif] text-[11px] text-[#6b6b6b] mt-1">
                      Applied when a professional buys a custom quantity of bids (e.g. 10 bids = £25.00 at £2.50 per bid).
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="space-y-4 border rounded-lg p-4">
                    <h4 className="font-['Poppins',sans-serif] text-[14px] font-medium text-[#2c353f]">Basic plan</h4>
                    <div>
                      <Label htmlFor="basicPlanPrice" className="font-['Poppins',sans-serif]">Price (£)</Label>
                      <div className="relative mt-2">
                        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 font-['Poppins',sans-serif]">£</span>
                        <Input
                          id="basicPlanPrice"
                          ...
                          onChange={(e) => updateField("basicPlanPrice", parseNumberInput(e.target.value, "float") || 0)}
                          className="pl-8 font-['Poppins',sans-serif] no-spinner"
                          min="0"
                          step="0.01"
                        />
                    ...
                    <div>
                      <Label htmlFor="basicPlanBids" className="font-['Poppins',sans-serif]">Bids</Label>
                      <Input
                        id="basicPlanBids"
                        type="number"
                        value={settings.basicPlanBids === "" ? "" : settings.basicPlanBids ?? 2}
                        onChange={(e) => updateField("basicPlanBids", parseNumberInput(e.target.value, "int") || 0)}
                        className="mt-2 font-['Poppins',sans-serif] no-spinner"
                        min="0"
                      />
                    </div>
                  ...
                  <div className="space-y-4 border rounded-lg p-4">
                    <h4 className="font-['Poppins',sans-serif] text-[14px] font-medium text-[#2c353f]">Standard plan</h4>
                    <div>
                      <Label htmlFor="standardPlanPrice" className="font-['Poppins',sans-serif]">Price (£)</Label>
                      <div className="relative mt-2">
                        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 font-['Poppins',sans-serif]">£</span>
                        <Input
                          id="standardPlanPrice"
                          type="number"
                          value={settings.standardPlanPrice === "" ? "" : settings.standardPlanPrice ?? 10}
                          onChange={(e) => updateField("standardPlanPrice", parseNumberInput(e.target.value, "float") || 0)}
                          className="pl-8 font-['Poppins',sans-serif] no-spinner"
                          min="0"
                          step="0.01"
                        />
                    ...
                    <div>
                      <Label htmlFor="standardPlanBids" className="font-['Poppins',sans-serif]">Bids</Label>
                      <Input
                        id="standardPlanBids"
                        type="number"
                        value={settings.standardPlanBids === "" ? "" : settings.standardPlanBids ?? 5}
                        onChange={(e) => updateField("standardPlanBids", parseNumberInput(e.target.value, "int") || 0)}
                        className="mt-2 font-['Poppins',sans-serif] no-spinner"
                        min="0"
                      />
                    </div>
                  ...
                  <div className="space-y-4 border rounded-lg p-4">
                    <h4 className="font-['Poppins',sans-serif] text-[14px] font-medium text-[#2c353f]">Premium plan</h4>
                    <div>
                      <Label htmlFor="premiumPlanPrice" className="font-['Poppins',sans-serif]">Price (£)</Label>
                      <div className="relative mt-2">
                        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 font-['Poppins',sans-serif]">£</span>
                        <Input
                          id="premiumPlanPrice"
                          type="number"
                          value={settings.premiumPlanPrice === "" ? "" : settings.premiumPlanPrice ?? 15}
                          onChange={(e) => updateField("premiumPlanPrice", parseNumberInput(e.target.value, "float") || 0)}
                          className="pl-8 font-['Poppins',sans-serif] no-spinner"
                          min="0"
                          step="0.01"
                        />
                    ...
                    <div>
                      <Label htmlFor="premiumPlanBids" className="font-['Poppins',sans-serif]">Bids</Label>
                      <Input
                        id="premiumPlanBids"
                        type="number"
                        value={settings.premiumPlanBids === "" ? "" : settings.premiumPlanBids ?? 15}
                        onChange={(e) => updateField("premiumPlanBids", parseNumberInput(e.target.value, "int") || 0)}
                        className="mt-2 font-['Poppins',sans-serif] no-spinner"
                        min="0"
                      />
                    </div>
