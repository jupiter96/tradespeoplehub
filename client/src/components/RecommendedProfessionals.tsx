  ...
  return (
    <div className="mt-8">
      <div className="bg-gradient-to-br from-blue-50 via-purple-50 to-orange-50 rounded-2xl shadow-sm p-6 md:p-8">
        {/* Header */}
        <div className="mb-6">
          <h2 className="font-['Poppins',sans-serif] text-[22px] text-[#2c353f] mb-2 flex items-center gap-2">
            ...
            >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {pro.skills.slice(0, 6).map((skill, index) => (
                      <Badge
                        key={index}
                        variant="secondary"
                        className="bg-blue-50 text-blue-700 hover:bg-blue-100 font-['Poppins',sans-serif] text-[12px] px-2.5 py-0.5 border-0"
                      >
                        {skill}
                      </Badge>
                    ))}
                    {pro.skills.length > 6 && (
                      <Badge
                        variant="secondary"
                        className="bg-gray-100 text-gray-600 font-['Poppins',sans-serif] text-[12px] px-2.5 py-0.5 border-0"
                      >
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  className="flex-1 bg-gradient-to-r from-[#FE8A0F] to-[#FF9E2C] hover:from-[#FF9E2C] hover:to-[#FE8A0F] text-white font-['Poppins',sans-serif] text-[14px] h-10 shadow-md hover:shadow-xl transition-all duration-300"
                >
                ...
                {onMessage && (
                  <Button
                    ...
                    variant="outline"
                    className="flex-1 border-2 border-blue-200 hover:border-blue-400 hover:bg-blue-50 text-blue-700 font-['Poppins',sans-serif] text-[14px] h-10 transition-all duration-300"
                  >
