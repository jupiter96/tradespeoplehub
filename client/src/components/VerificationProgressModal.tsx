...
export default function VerificationProgressModal(props: {
  ...
  return (
    <Dialog open={props.open} onOpenChange={props.onOpenChange}>
      <DialogContent className="max-w-[920px] h-[70vh] p-0 overflow-hidden flex flex-col">
        <DialogHeader className="sr-only">
          <DialogTitle>Account verification progress</DialogTitle>
        </DialogHeader>
        <div className="min-h-0 flex flex-col p-6 md:p-8 overflow-hidden">
          {/* Progress Overview Card (same visual language as Account Verification) */}
          <div className="bg-gradient-to-br from-[#FFF5EB] via-white to-[#E3F2FD] border-2 border-[#FE8A0F] rounded-2xl p-6 md:p-8 flex-shrink-0">
            <div className="mb-6">
          ...
          <div className="flex-1 min-h-0 overflow-y-auto mt-4 pr-2 -mr-2">
          ...
          {/* Actions */}
          <div className="mt-4 pt-4 border-t border-gray-200 flex flex-col sm:flex-row gap-3 sm:justify-end flex-shrink-0">
            <Button
              type="button"
              variant="outline"
