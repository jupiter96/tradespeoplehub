...
import AdminRatingsManagePage from "./admin/AdminRatingsManagePage";
          ...
          {loadingStats ? (
            ...
            <section className="grid gap-4 grid-cols-1 md:grid-cols-3">
              ...
              {[
                ...
                { title: "FLAGGED", icon: AlertCircle, color: "orange" as const, value: statistics?.flagged || 0, dailyChange: statistics?.flaggedDailyChange, badge: statistics?.flaggedNew || 0, onClick: () => navigate("/admin/flagged") },
                // Red Cards
                  ...
                  {loadingStats ? (
                    ...
                    <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      {[
                        ...
                        { show: shouldShowCard("FLAGGED"), icon: AlertCircle, title: "FLAGGED", value: statistics?.flagged || 0, color: "orange" as const, dailyChange: statistics?.flaggedDailyChange, badge: statistics?.flaggedNew || 0, onClick: () => navigate("/admin/flagged") },
