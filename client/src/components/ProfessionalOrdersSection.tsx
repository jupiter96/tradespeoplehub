              ...
              <TabsContent value="timeline" className="mt-6 space-y-6">
                ...
                {currentOrder.deliveryStatus === "delivered" && (
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <h4 className="font-['Roboto',sans-serif] text-[20px] text-[#2c353f] mb-3">
                    ...
                    <div className="flex justify-end">
                      <Button
                        onClick={() => handleStartConversation(currentOrder.client || "", currentOrder.clientAvatar || "")}
                        variant="outline"
                        className="font-['Roboto',sans-serif] border-[#FE8A0F] text-[#FE8A0F] hover:bg-[#FE8A0F] hover:text-white"
                      >
                        Chat
                      </Button>
                    </div>
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                              <img 
                                src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkb2N1bWVudCUyMGZpbGV8ZW58MXx8fHwxNzYzMTQ5NDI3fDA&ixlib=rb-4.1.0&q=80&w=1080"
                                alt="Attachment"
                ...
                <div className="mb-6">
                  ...
                  {currentOrder.clientEmail && (
                    <div className="flex items-center gap-2 mt-2 text-[#6b6b6b]">
                      ...
                      <span className="font-['Roboto',sans-serif] text-[12px] truncate">
                        {currentOrder.clientEmail}
                      </span>
                    </div>
                  )}
                ...
                {currentOrder.deliveryStatus === "active" && (
                  <>
                    ...
                    <div className="space-y-2">
                      <Button
                        onClick={() => setIsDeliveryDialogOpen(true)}
                        className="w-full bg-[#FE8A0F] hover:bg-[#FFB347] font-['Roboto',sans-serif] text-[13px]"
                      >
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="font-['Roboto',sans-serif]">Client</TableHead>
                    ...
                    <TableRow key={order.id} className="hover:bg-gray-50">
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-['Roboto',sans-serif] text-[13px]">{order.client}</span>
                        </div>
                      </TableCell>
