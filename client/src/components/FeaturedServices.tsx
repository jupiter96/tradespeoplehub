...
import { Star, ChevronLeft, ChevronRight, Grid, List, Heart, MapPin, BadgeCheck, Medal, Play, Clock } from "lucide-react";
          ...
          {services.slice(0, visibleCount).map((service) => {
            ...
            return (
              <ServiceCard
                ...
                showHeart
                isLiked={isLiked}
                onLikeClick={(e) => toggleLike(e, service)}
              />
            );
          })}
        </div>
              ...
              >
                ...
                <div className="flex-1 p-3 md:p-4 flex flex-col min-w-0">
                  ...
                  {(() => {
                    ...
                    const reviewsCount = service.providerReviewCount ?? service.reviewCount;
...
export default function FeaturedServices() {
  ...
  const featuredServices: Service[] = useMemo(() => {
    ...
    const mapped = sliced.map(s => ({
      ...
      slug: s.slug,
      image: s.image,
      thumbnailVideo: (s as any).thumbnailVideo || null,
