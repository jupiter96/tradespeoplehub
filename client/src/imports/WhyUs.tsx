import svgPaths from "./svg-zi4ltcayd6";

function Component5() {
  return (
    <div className="absolute left-[-100px] size-[42px] top-[123px]" data-name="13788385171645479138 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42 42">
        <g id="13788385171645479138 1">
          <path d={svgPaths.p2443acf0} fill="var(--fill-0, #3D78CB)" id="Vector" />
          <path d={svgPaths.p2db3fb00} fill="var(--fill-0, #FE8A0F)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Group() {
  return (
    <div className="absolute bottom-[10.71%] left-0 right-0 top-[10.71%]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 32">
        <g id="Group">
          <path d={svgPaths.p1aed3700} fill="var(--fill-0, #FE8A0F)" id="Vector" />
          <path d={svgPaths.p14b6ba80} fill="var(--fill-0, #FE8A0F)" id="Vector_2" />
          <path d={svgPaths.p33736c80} fill="var(--fill-0, #FE8A0F)" id="Vector_3" />
          <path d={svgPaths.p341e9700} fill="var(--fill-0, #3D78CB)" id="Vector_4" />
          <path d={svgPaths.p2bb76300} fill="var(--fill-0, #3D78CB)" id="Vector_5" />
          <path d={svgPaths.p2bccdd80} fill="var(--fill-0, #3D78CB)" id="Vector_6" />
        </g>
      </svg>
    </div>
  );
...
function Group10() {
  return (
    <div className="absolute bottom-[10.71%] contents left-0 right-0 top-[10.71%]" data-name="Group">
      <Group />
    </div>
  );
}
...
function Component4() {
  return (
    <div className="overflow-clip relative size-[40px]" data-name="12199761061582634792 1">
      <Group10 />
    </div>
  );
}
...
function Component6() {
  return (
    <div className="absolute left-[-100px] size-[43px] top-[285px]" data-name="17873481351677484406 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 43 43">
        <g id="17873481351677484406 1">
          <path d={svgPaths.p27859400} fill="var(--fill-0, #3D78CB)" id="Vector" />
          <path d={svgPaths.p649b1c0} fill="var(--fill-0, #3D78CB)" id="Vector_2" />
          <path d={svgPaths.p903e500} fill="var(--fill-0, #FE8A0F)" id="Vector_3" />
          <path d={svgPaths.p27556800} fill="var(--fill-0, #3D78CB)" id="Vector_4" />
        </g>
      </svg>
    </div>
  );
...
function LayerX1() {
  return (
    <div className="absolute bottom-[7.63%] left-0 right-0 top-[7.63%]" data-name="Layer_x0020_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 34">
        <g id="Layer_x0020_1">
          <path clipRule="evenodd" d={svgPaths.p2effe380} fill="var(--fill-0, #FE8A0F)" fillRule="evenodd" id="Vector" />
          <path clipRule="evenodd" d={svgPaths.pf80efd0} fill="var(--fill-0, #3D78CB)" fillRule="evenodd" id="Vector_2" />
          <path clipRule="evenodd" d={svgPaths.p2363ae80} fill="var(--fill-0, #FE8A0F)" fillRule="evenodd" id="Vector_3" />
          <path clipRule="evenodd" d={svgPaths.pd00fc80} fill="var(--fill-0, #FE8A0F)" fillRule="evenodd" id="Vector_4" />
        </g>
      </svg>
    </div>
  );
...
function Component8() {
  return (
    <div className="absolute left-[-99px] overflow-clip size-[40px] top-[454px]" data-name="19525892731667326706 (1) 1">
      <LayerX1 />
    </div>
  );
}
...
function Component7() {
  return (
    <div className="absolute left-[475px] size-[41px] top-[286px]" data-name="19333191211578888104 (3) 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 41 41">
        <g id="19333191211578888104 (3) 1">
          <path d={svgPaths.p27c39700} fill="var(--fill-0, #3D78CB)" id="Vector" />
          <path d={svgPaths.p30826000} fill="var(--fill-0, #FE8A0F)" id="Vector_2" />
          <path d={svgPaths.p16b99680} fill="var(--fill-0, #FE8A0F)" id="Vector_3" />
          <path d={svgPaths.p17afea60} fill="var(--fill-0, #FE8A0F)" id="Vector_4" />
        </g>
      </svg>
    </div>
  );
...
function Component3() {
  return (
    <div className="absolute inset-[661.76%_37.74%_-627.94%_56.85%]" data-name="5046402361595501401 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 45 45">
        <g id="5046402361595501401 1">
          <path d={svgPaths.p3ae14200} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Group6() {
  return (
    <div className="absolute contents left-[448px] top-[406px]">
...
function Component2() {
  return (
    <div className="absolute left-[474px] size-[42px] top-[451px]" data-name="2097212141683774427 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42 42">
        <g id="2097212141683774427 1">
          <path d={svgPaths.p3ebf100} fill="var(--fill-0, #FE8A0F)" id="Vector" />
          <path d={svgPaths.pa8bd200} fill="var(--fill-0, #3D78CB)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Component1() {
  return (
    <div className="absolute left-[-100px] size-[44px] top-[611px]" data-name="1853078101582962142 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 44 44">
        <g id="1853078101582962142 1">
          <path d={svgPaths.p1fe1e8f2} fill="var(--fill-0, #FE8A0F)" id="Vector" />
          <path d={svgPaths.pa4ff800} fill="var(--fill-0, #FE8A0F)" id="Vector_2" />
          <path d={svgPaths.p32d10f00} fill="var(--fill-0, #3D78CB)" id="Vector_3" />
          <path d={svgPaths.p378c5e80} fill="var(--fill-0, #3D78CB)" id="Vector_4" />
        </g>
      </svg>
    </div>
  );
...
function LayerX() {
  return (
    <div className="absolute bottom-0 left-[-0.02%] right-0 top-0" data-name="Layer_x0020_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42 42">
        <g id="Layer_x0020_1">
          <path clipRule="evenodd" d={svgPaths.p237d2a00} fill="var(--fill-0, #3D78CB)" fillRule="evenodd" id="Vector" />
          <path clipRule="evenodd" d={svgPaths.p21936900} fill="var(--fill-0, #FE8A0F)" fillRule="evenodd" id="Vector_2" />
          <path clipRule="evenodd" d={svgPaths.p71ad00} fill="var(--fill-0, #FE8A0F)" fillRule="evenodd" id="Vector_3" />
          <path clipRule="evenodd" d={svgPaths.p1498e080} fill="var(--fill-0, #FE8A0F)" fillRule="evenodd" id="Vector_4" />
          <path clipRule="evenodd" d={svgPaths.p3bff0f00} fill="var(--fill-0, #FE8A0F)" fillRule="evenodd" id="Vector_5" />
        </g>
      </svg>
    </div>
  );
...
function Component() {
  return (
    <div className="absolute inset-[902.94%_37.5%_-864.71%_57.45%] overflow-clip" data-name="1462878221679911955 1">
      <LayerX />
    </div>
  );
}
