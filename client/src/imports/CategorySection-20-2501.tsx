import svgPaths from "./svg-mbiotk3qod";
import imgGarden2 from "figma:asset/505ec7a20e1b305a30cd4ca5d2971e8c6ecbf2bc.png";
import imgBusiness2 from "figma:asset/067477e84f5320dfe83e3d768945fa2e20caeec4.png";
import imgDriving2 from "figma:asset/7982e25e89413acdfdc5588a1b82c90910205f0f.png";
import imgEducation2 from "figma:asset/9e2ad0c0ba99302026a62ba196c4effa34124b21.png";
import imgVehicles2 from "figma:asset/3eb60da91b670e870d18bb6dc5f52f4e45f92329.png";
import imgLogistic1 from "figma:asset/23ed9cc11da84dbe8eb22e3eeb81173051f8b986.png";

function Component() {
  return (
    <div className="h-[6px] relative w-[10px]" data-name="17248848271579697358 (2) 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 6">
        <g id="17248848271579697358 (2) 2">
          <path clipRule="evenodd" d={svgPaths.p2cf2c200} fill="var(--fill-0, #3D78CB)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Group() {
  return (
    <div className="absolute contents left-[2px] top-[20px]">
      <div className="absolute bg-white h-[170px] left-[2px] rounded-[10px] shadow-[0px_14px_18px_0px_#ecf0f5] top-[20px] w-[156px]" />
      <div className="absolute left-[55px] size-[50px] top-[44px]" data-name="Garden 2">
...
function Group1() {
  return (
    <div className="absolute contents left-[195px] top-[20px]">
      <div className="absolute bg-white h-[170px] left-[195px] rounded-[10px] shadow-[0px_14px_18px_0px_#ecf0f5] top-[20px] w-[156px]" />
...
function Group2() {
  return (
    <div className="absolute contents left-[387px] top-[20px]">
      <div className="absolute bg-white h-[170px] left-[387px] rounded-[10px] shadow-[0px_14px_18px_0px_#ecf0f5] top-[20px] w-[156px]" />
...
function Group3() {
  return (
    <div className="absolute contents left-[579px] top-[20px]">
      <div className="absolute bg-white h-[170px] left-[579px] rounded-[10px] shadow-[0px_14px_18px_0px_#ecf0f5] top-[20px] w-[156px]" />
...
function Group4() {
  return (
    <div className="absolute contents left-[772px] top-[20px]">
      <div className="absolute bg-white h-[170px] left-[772px] rounded-[10px] shadow-[0px_14px_18px_0px_#ecf0f5] top-[20px] w-[156px]" />
...
function Group5() {
  return (
    <div className="absolute contents left-[964px] top-[20px]">
      <div className="absolute bg-white h-[170px] left-[964px] rounded-[10px] shadow-[0px_14px_18px_0px_#ecf0f5] top-[20px] w-[156px]" />
